...
import BigBrainIcon from "./BigBrainIcon";
import BigBrainCrossFadeIcon from './BigBrainCrossFadeIcon';
...
const BigBrainFab = ({
  ...
  const IconComponent = animated ? BigBrainCrossFadeIcon : BigBrainIcon;
