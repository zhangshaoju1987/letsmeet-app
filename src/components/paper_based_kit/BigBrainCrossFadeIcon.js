...
import Icon, { isValidIcon, isEqualIcon } from './BigBrainIcon';

import {withTheme } from 'react-native-paper';


const BigBrainCrossFadeIcon = ({ color, size, source, theme }) => {
...
export default withTheme(BigBrainCrossFadeIcon);
